<?php
// source: /var/www/html/junior.hack.2017/client/app/config/config.neon 
// source: /var/www/html/junior.hack.2017/client/app/config/config.local.neon 

class Container_f93ed73e3b extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'ApiModule\Managers\ScriptManager' => [1 => ['scriptManager']],
			'App\Models\DbModel' => [1 => ['DbModel']],
			'App\Models\HomeModel' => [1 => ['homeModel']],
			'App\Presenters\BasePresenter' => [1 => ['application.1', 'application.2', 'application.4']],
			...
			'App\Presenters\DbPresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.4' => 'App\Presenters\DbPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => '/var/www/html/junior.hack.2017/client/app',
			'wwwDir' => '/var/www/html/junior.hack.2017/client/www',
			'debugMode' => false,
			'productionMode' => true,
			'consoleMode' => false,
			'tempDir' => '/var/www/html/junior.hack.2017/client/app/../temp',
	...
	public function createService__DbModel(): App\Models\DbModel
	{
		$service = new App\Models\DbModel($this->getService('doctrine.default.entityManager'));
		return $service;
	}
	...
	public function createServiceAnnotations__cache__annotations(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Annotations',
			false);
		$service->setNamespace('Kdyby_annotations.cache.annotations_b850b3ca');
		return $service;
	}
	...
	public function createServiceApplication__4(): App\Presenters\DbPresenter
	{
		$service = new App\Presenters\DbPresenter($this->getService('DbModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->invalidLinkMode = 1;
		$service->onShutdown = $this->getService('events.manager')->createEvent(['App\Presenters\DbPresenter', 'onShutdown'],
			$service->onShutdown, null, false);
		$service->onAnchor = $this->getService('events.manager')->createEvent(['App\Presenters\DbPresenter', 'onAnchor'],
			$service->onAnchor, null, false);
		return $service;
	}


	public function createServiceApplication__5(): KdybyModule\CliPresenter
	{
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('/var/www/html/junior.hack.2017/client/app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/html/junior.hack.2017/client/app/../temp/cache',
	...
	public function createServiceDoctrine__cache__default__dbalResult(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.dbalResult',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.dbalResult_b850b3ca');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__hydration(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.hydration',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.hydration_b850b3ca');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__metadata(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.metadata',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.metadata_b850b3ca');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__ormResult(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.ormResult',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.ormResult_b850b3ca');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__query(): Doctrine\Common\Cache\Cache
	{
		$service = new Kdyby\DoctrineCache\Cache($this->getService('cache.storage'), 'Doctrine.Default.query',
			false);
		$service->setNamespace('Kdyby_doctrine.cache.default.query_b850b3ca');
		return $service;
	}
	...
	public function createServiceDoctrine__daoFactory(): Kdyby\Doctrine\EntityDaoFactory
	{
		return new class ($this) implements Kdyby\Doctrine\EntityDaoFactory {
			...
			public function __construct(Container_f93ed73e3b $container)
			{
	...
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(['/var/www/html/junior.hack.2017/client/app'],
	...
	public function createServiceDoctrine__default__driver__Kdyby_Doctrine__annotationsImpl(): Doctrine\Common\Persistence\Mapping\Driver\MappingDriver
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver([
			'/var/www/html/junior.hack.2017/client/vendor/kdyby/doctrine/src/Kdyby/Doctrine/DI/../Entities',
		], $this->getService('annotations.reader'), $this->getService('doctrine.cache.default.metadata'));
		return $service;
	}
	...
	public function createServiceDoctrine__default__ormConfiguration(): Kdyby\Doctrine\Configuration
	{
		...
		$service->setProxyDir('/var/www/html/junior.hack.2017/client/app/../temp/proxies');
	...
	public function createServiceHomeModel(): App\Models\HomeModel
	{
		$service = new App\Models\HomeModel($this->getService('scriptManager'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/var/www/html/junior.hack.2017/client/app/../temp/cache/latte');
	...
	public function createServiceScriptManager(): ApiModule\Managers\ScriptManager
	{
		$service = new ApiModule\Managers\ScriptManager;
		return $service;
	}
	...
	{
		Kdyby\Doctrine\Proxy\ProxyAutoloader::create('/var/www/html/junior.hack.2017/client/app/../temp/proxies', 'Kdyby\GeneratedProxy')->register();Doctrine\Common\Annotations\AnnotationRegistry::registerLoader("class_exists");
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/var/www/html/junior.hack.2017/client/vendor/kdyby/doctrine/src/Kdyby/Doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/var/www/html/junior.hack.2017/client/vendor/doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/var/www/html/junior.hack.2017/client/app/../temp/proxies';
	}
}
